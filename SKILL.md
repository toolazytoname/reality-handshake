...
- TPROXY `EADDRINUSE`, empty netstat, health stuck in `direct`, or a transparent proxy that stayed down for days: read [references/tproxy-ghost-socket.md](references/tproxy-ghost-socket.md).
